...
class LoginPageUI(BasePageUI):
    ...
    def setup_ui(self):
        layout = self.ui_factory.create_layout(
            ...
            spacing=20,
            elements=[
                {"widget": self.create_log_navbar_frame(), "spacing": 60},
                {
    ...
    def create_log_navbar_frame(self):
    ...
    def create_main_layout(self):
        ...
        username_text = self.ui_factory.create_line_edit(
            placeholder_text="",
        ...
        password_text = self.ui_factory.create_line_edit(
            placeholder_text="",
            alignment=Qt.AlignCenter,
        ...
        frame_layout = self.ui_factory.create_layout(
            ...
            elements=[
                ...
                {"widget": username_text, "alignment": Qt.AlignTop | Qt.AlignHCenter},
